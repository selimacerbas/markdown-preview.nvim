...
- [ ] No attribution trailer such as `Co-authored-by` or `Signed-off-by`, no em dash character and no workflow skip instruction in the title, the body or the commits (see CONTRIBUTING.md, Commits)
